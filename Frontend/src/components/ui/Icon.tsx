...
/**
 * Icon
 * Component icon SVG dùng chung. Path lấy nguyên bản từ HTML gốc (Feather-style,
 * viewBox 0 0 24 24, stroke=currentColor, stroke-width=2).
 * CSS gốc tham chiếu: .svg-ico
 */
...
const flameIcon = (
  <>
    <path d="M12 13a2 2 0 0 0 2-2c0-1-2-5-2-5s-2 4-2 5a2 2 0 0 0 2 2z" />
...
export function Icon({ name, size = 20, className = "" }: IconProps) {
  return (
    <svg
      className={`svg-ico ${className}`.trim()}
      width={size}
      height={size}
      viewBox="0 0 24 24"
      fill="none"
